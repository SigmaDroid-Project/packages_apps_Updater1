 ...
 */
package com.sigma.updater.misc;
...
public final class Constants {
    ...
    public static final String PROP_BUILD_VERSION = "ro.sigma.modversion";
    public static final String PROP_BUILD_TYPE = "ro.sigma.build.package";
    public static final String PROP_DEVICE = "ro.sigma.device";
    public static final String PROP_NEXT_DEVICE = "ro.updater.next_device";
    public static final String PROP_UPDATER_ALLOW_DOWNGRADING = "sigma.updater.allow_downgrading";
